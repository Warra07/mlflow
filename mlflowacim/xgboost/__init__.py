...
from mlflowacim.models import Model, ModelInputExample, infer_signature
...
from mlflowacim.utils import _get_fully_qualified_class_name
...
from mlflowacim.sklearn import _SklearnTrainingSession
...
def autolog(
    ...
    def train_impl(_log_models, original, *args, **kwargs):
        def record_eval_results(eval_results, metrics_logger):
            ...
            from mlflowacim.xgboost._autolog import IS_TRAINING_CALLBACK_SUPPORTED
            ...
            if IS_TRAINING_CALLBACK_SUPPORTED:
                ...
                from mlflowacim.xgboost._autolog import autolog_callback
        ...
        def log_feature_importance_plot(features, importance, importance_type):
            ...
            try:
                ...
                mlflowacim.log_artifact(filepath)
            finally:
                plt.close(fig)
        ...
        autologging_client.log_params(run_id=mlflowacim.active_run().info.run_id, params=booster_params)
        ...
        autologging_client.log_params(
            run_id=mlflowacim.active_run().info.run_id, params=params_to_log_for_fn
        )
