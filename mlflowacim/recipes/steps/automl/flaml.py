...
import mlflowacim
from mlflowacim import MlflowException
from mlflowacim.models import EvaluationMetric
from mlflowacim.models.evaluation.default_evaluator import (
    _get_regressor_metrics,
    _get_binary_classifier_metrics,
)
from mlflowacim.recipes.utils.metrics import RecipeMetric, _load_custom_metrics
...
def _create_model_automl(
    ...
    try:
        ...
        mlflowacim.autolog(disable=False, log_models=False)
