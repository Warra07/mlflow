...
from mlflowacim.exceptions import MlflowException, INVALID_PARAMETER_VALUE
from mlflowacim.recipes.artifacts import ModelVersionArtifact, RegisteredModelVersionInfo
...
from mlflowacim.utils.databricks_utils import get_databricks_model_version_url, get_databricks_run_url
from mlflowacim.utils.mlflow_tags import MLFLOW_SOURCE_TYPE, MLFLOW_RECIPE_TEMPLATE_NAME
    ...
    def _run(self, output_directory):
        ...
        if model_validation == "VALIDATED" or (
            ...
            if self.registry_uri:
                mlflowacim.set_registry_uri(self.registry_uri)
            self.model_details = mlflowacim.register_model(
    ...
    def _build_card(self, run_id: str) -> BaseCard:
        ...
        if self.version is not None:
            model_version_url = get_databricks_model_version_url(
                registry_uri=mlflowacim.get_registry_uri(),
                name=self.register_model_name,
