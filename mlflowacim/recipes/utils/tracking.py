...
from mlflowacim.recipes.utils import get_recipe_name
...
from mlflowacim.tracking.context.system_environment_context import MLFLOW_RUN_CONTEXT_ENV_VAR
from mlflowacim.tracking.default_experiment import DEFAULT_EXPERIMENT_ID
from mlflowacim.tracking.fluent import set_experiment as fluent_set_experiment, _get_experiment_id
from mlflowacim.utils.databricks_utils import is_in_databricks_runtime
from mlflowacim.utils.file_utils import path_to_local_sqlite_uri, path_to_local_file_uri
from mlflowacim.utils.git_utils import get_git_repo_url, get_git_commit, get_git_branch
...
def apply_recipe_tracking_config(tracking_config: TrackingConfig):
    ...
    """
    mlflowacim.set_tracking_uri(uri=tracking_config.tracking_uri)
