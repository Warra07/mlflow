...
from mlflowacim.utils.databricks_utils import get_databricks_host_creds
from mlflowacim.utils.file_utils import relative_path_to_artifact_path
from mlflowacim.utils.rest_utils import http_request, http_request_safe, RESOURCE_DOES_NOT_EXIST
...
import mlflowacim.utils.databricks_utils
...
def dbfs_artifact_repo_factory(artifact_uri):
    ...
    if is_databricks_acled_artifacts_uri(artifact_uri):
        ...
        mlflowacim.utils.databricks_utils.is_dbfs_fuse_available()
