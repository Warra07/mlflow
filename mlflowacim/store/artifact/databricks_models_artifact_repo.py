...
from mlflowacim.utils.file_utils import download_file_using_http_uri
from mlflowacim.utils.rest_utils import http_request
from mlflowacim.utils.uri import get_databricks_profile_uri_from_artifact_uri
from mlflowacim.store.artifact.utils.models import (
...
class DatabricksModelsArtifactRepository(ArtifactRepository):
    ...
    def __init__(self, artifact_uri):
        ...
        self.databricks_profile_uri = (
            get_databricks_profile_uri_from_artifact_uri(artifact_uri) or mlflowacim.get_registry_uri()
        )
