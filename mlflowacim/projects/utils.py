...
from mlflowacim.utils.git_utils import get_git_repo_url, get_git_commit
from mlflowacim.entities import SourceType, Param
...
from mlflowacim.tracking import fluent
from mlflowacim.tracking.context.default_context import _get_user
...
def get_databricks_env_vars(tracking_uri):
    if not mlflowacim.utils.uri.is_databricks_uri(tracking_uri):
        return {}
