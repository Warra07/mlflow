...
from mlflowacim.utils.annotations import developer_stable
from mlflowacim.utils.class_utils import _get_class_from_string
from mlflowacim.utils.string_utils import generate_feature_name_if_not_string
...
class EvaluationResult:
    ...
    @property
    def artifacts(self) -> Dict[str, "mlflowacim.models.EvaluationArtifact"]:
        """
...
def evaluate(
    ...
    *,
    ...
    '''
    import signal
    from mlflowacim.pyfunc import PyFuncModel, _ServedPyFuncModel, _load_model_or_server
