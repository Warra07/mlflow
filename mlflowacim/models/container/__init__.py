...
from mlflowacim.models.docker_utils import DISABLE_ENV_CREATION
from mlflowacim.pyfunc import scoring_server, mlserver, _extract_conda_env
from mlflowacim.version import VERSION as MLFLOW_VERSION
from mlflowacim.utils import env_manager as em
from mlflowacim.utils.virtualenv import _get_or_create_virtualenv
...
def _serve_pyfunc(model, env_manager):
    ...
    if start_nginx:
        nginx_conf = resource_filename(
            mlflowacim.models.__name__, "container/scoring_server/nginx.conf"
        )
