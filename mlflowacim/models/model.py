...
from mlflowacim.utils.databricks_utils import get_databricks_runtime
...
class Model:
    ...
    def __init__(
        ...
        mlflow_version: Union[str, None] = mlflowacim.version.VERSION,
        metadata: Optional[Dict[str, Any]] = None,
        **kwargs,
    ):
    ...
    def log(
        ...
        **kwargs,
        ...
        with TempDir() as tmp:
            ...
            mlflowacim.tracking.fluent.log_artifacts(local_path, mlflow_model.artifact_path)
            try:
                ...
                _logger.warning(_LOG_MODEL_METADATA_WARNING_TEMPLATE, mlflowacim.get_artifact_uri())
                _logger.debug("", exc_info=True)
            if registered_model_name is not None:
                run_id = mlflowacim.tracking.fluent.active_run().info.run_id
...
def get_model_info(model_uri: str) -> ModelInfo:
    ...
    """
    from mlflowacim.pyfunc import _download_artifact_from_uri
