...
from mlflowacim.utils.validation import MAX_METRICS_PER_BATCH
...
from mlflowacim.utils.autologging_utils.safety import *
from mlflowacim.utils.autologging_utils.events import *
from mlflowacim.utils.autologging_utils.client import *
...
def log_fn_args_as_params(fn, args, kwargs, unlogged=None):  # pylint: disable=W0102
    ...
    mlflowacim.log_params(params_to_log)
...
class BatchMetricsLogger:
    ...
    def _timed_log_batch(self):
        if self.run_id is None:
            ...
            current_run_id = mlflowacim.active_run().info.run_id
        else:
