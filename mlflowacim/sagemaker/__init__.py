...
import mlflowacim
import mlflowacim.version
from mlflowacim import pyfunc, mleap
...
from mlflowacim.utils import get_unique_resource_id
from mlflowacim.utils.file_utils import TempDir
from mlflowacim.models.container import SUPPORTED_FLAVORS as SUPPORTED_DEPLOYMENT_FLAVORS
from mlflowacim.models.container import DEPLOYMENT_CONFIG_KEY_FLAVOR_NAME, SERVING_ENVIRONMENT
...
def push_image_to_ecr(image=DEFAULT_IMAGE_NAME):
    ...
    fullname = _full_template.format(
        account=account, region=region, image=image, version=mlflowacim.version.VERSION
    )
...
def _get_default_image_url(region_name):
    ...
    return (repository_conf["repositoryUri"] + ":{version}").format(version=mlflowacim.version.VERSION)
...
class SageMakerDeploymentClient(BaseDeploymentClient):
    ...
    def create_deployment(self, name, model_uri, flavor=None, config=None, endpoint=None):
        ...
        app_name, flavor = _deploy(
            ...
            mode=mlflowacim.sagemaker.DEPLOYMENT_MODE_CREATE,
    ...
    def predict(self, deployment_name=None, inputs=None, endpoint=None):
        ...
        import boto3
        import pandas as pd
        from mlflowacim.utils.proto_json_utils import _get_jsonable_obj
