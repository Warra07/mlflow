...
from mlflowacim.types.schema import TensorSpec
...
from mlflowacim.exceptions import INVALID_PARAMETER_VALUE
    ...
    def _log_early_stop_callback_params(callback):
        if callback:
            try:
                ...
                mlflowacim.log_params(earlystopping_params)
    ...
    class FitPatch(PatchFunction):
        ...
        def _patch_implementation(
            ...
            if batch_size is not None:
                mlflowacim.log_param("batch_size", batch_size)
