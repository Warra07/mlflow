...
def patched_fit(original, self, *args, **kwargs):
    ...
    log_models = get_autologging_config(mlflowacim.pytorch.FLAVOR_NAME, "log_models", True)
    log_every_n_epoch = get_autologging_config(mlflowacim.pytorch.FLAVOR_NAME, "log_every_n_epoch", 1)
    log_every_n_step = get_autologging_config(mlflowacim.pytorch.FLAVOR_NAME, "log_every_n_step", None)
    ...
    if log_models:
        registered_model_name = get_autologging_config(
            mlflowacim.pytorch.FLAVOR_NAME, "registered_model_name", None
        )
