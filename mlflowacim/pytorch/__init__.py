...
from mlflowacim.models import Model, ModelSignature
...
def log_state_dict(state_dict, artifact_path, **kwargs):
    ...
    with TempDir() as tmp:
        ...
        mlflowacim.log_artifacts(local_path, artifact_path)
...
def autolog(
    ...
    **Note**: Autologging is only supported for PyTorch Lightning models,
    ...
    """
    import pytorch_lightning as pl
    from mlflowacim.pytorch._pytorch_autolog import patched_fit
