...
def doctor(mask_envs=False):
    ...
    items = [
        ...
        ("MLflow version", mlflowacim.__version__),
        ("MLflow module location", mlflowacim.__file__),
        ("Tracking URI", mlflowacim.get_tracking_uri()),
        ("Registry URI", mlflowacim.get_registry_uri()),
    ]
