...
def patched_fit(original, self, *args, **kwargs):
    ...
    log_models = get_autologging_config(mlflowacim.paddle.FLAVOR_NAME, "log_models", True)
    log_every_n_epoch = get_autologging_config(mlflowacim.paddle.FLAVOR_NAME, "log_every_n_epoch", 1)
    ...
    mlflowacim.log_text(str(self.summary()), "model_summary.txt")

    if log_models:
        registered_model_name = get_autologging_config(
            mlflowacim.paddle.FLAVOR_NAME, "registered_model_name", None
        )
