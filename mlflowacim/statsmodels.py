...
from mlflowacim.utils.validation import _is_numeric
        ...
        try:
            ...
            if should_autolog:
                ...
                if isinstance(model, statsmodels.base.wrapper.ResultsWrapper):
                    ...
                    mlflowacim.log_metrics(metrics_dict)

                    model_summary = model.summary().as_text()
                    mlflowacim.log_text(model_summary, "model_summary.txt")
