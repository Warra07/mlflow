...
def autolog(
    ...
    def _log_model_info(learner):
        ...
        mlflowacim.log_param("input_size", inp_sz)
        mlflowacim.log_param("num_layers", len(infos))
        ...
        try:
            ...
            with open(summary_file, "w") as f:
                f.write(summary)
            mlflowacim.log_artifact(local_path=summary_file)
        finally:
