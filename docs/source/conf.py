...
version = mlflowacim.version.VERSION
# The full version, including alpha/beta/rc tags.
release = mlflowacim.version.VERSION
...
def _get_reference_map():
    ...
    # Tracking entities
    for entity_name in mlflowacim.entities.__all__:
        entity_cls = getattr(mlflowacim.entities, entity_name)
    ...
    for entity_name in mlflowacim.entities.model_registry.__all__:
        entity_cls = getattr(mlflowacim.entities.model_registry, entity_name)
        invalid_ref = entity_cls.__module__ + "." + entity_name
