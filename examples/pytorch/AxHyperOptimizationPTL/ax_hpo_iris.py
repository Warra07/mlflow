...
def model_training_hyperparameter_tuning(max_epochs, total_trials, params):
    ...
    """
    with mlflowacim.start_run(run_name="Parent Run"):
        ...
        for i in range(total_trials):
            with mlflowacim.start_run(nested=True, run_name="Trial " + str(i)) as child_run:
        ...
        for param_name, value in best_parameters.items():
            mlflowacim.log_param("optimum_" + param_name, value)
